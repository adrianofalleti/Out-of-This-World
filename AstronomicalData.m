...
{
    // questo è un modo più veloce per inizializzare un mutable array.per farlo dobbiamo CHIAMARE UN METODO SU UN ARRAY VUOTO : [ @[] mutableCopy ]
    NSMutableArray *planetInformation = [@[] mutableCopy];
    // eccole qua.PLANET_NAME STA PER @"Planet Name"
